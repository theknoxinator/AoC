...
if __name__ == '__main__':
    ...
    # The message is going to be the least repeated letter in each position, so create an array of maps to
    ...
    # With all the character counts, now determine which character is least repeated in each position
    message = ""
