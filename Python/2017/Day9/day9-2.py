...
# Second part: Determine the amount of garbage in the input
...
if __name__ == "__main__":
    ...
    while index < len(input):
        if input[index] == '{' and not is_garbage:
            ...
            # This character is not special and contained within a garbage part, so count it
            garbage += 1
        index += 1

    print("The score of this input is: {0!s}".format(score))
    print("The amount of garbage in this input is: {0!s}".format(garbage))
