# Find the guard that is asleep the most on a given minute
...
if __name__ == '__main__':
    ...
    # Print out answer
    print("The most consistently sleepiest guard is #{0}, who slept the most at 00:{1} for a total of {2}".format(sleepiest_guard, str(sleepiest_minute), str(int(sleepiest_guard) * sleepiest_minute)))
