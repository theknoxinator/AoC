# Determine the best ratio of ingredients to make the highest scoring cookie while staying under
# 500 calories
...
if __name__ == '__main__':
    ...
    # With the ingredients that we have, there must be 60 of the first two combined and 40 of the
    # second two combined
    amounts = [30,30,31,9]
